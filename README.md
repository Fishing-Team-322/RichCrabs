...
Краткий запуск и базовая проверка:

- Поднимите окружение командой выше.
- Проверьте health gateway и API (примеры ниже в разделе **Python gateway (FastAPI)**).
- Для подробного сценария установки и запуска используйте раздел [Документация](#документация).
