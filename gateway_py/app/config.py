...
class Config(BaseModel):
    ...
    telegram_webapp_signing_key: str = os.getenv("GW_TELEGRAM_WEBAPP_SIGNING_KEY", os.getenv("GW_SESSION_SIGNING_KEY", "dev-insecure-session-key"))
    telegram_webapp_ttl_seconds: int = int(os.getenv("GW_TELEGRAM_WEBAPP_TTL_SECONDS", "120"))
    telegram_webapp_quiz_url: str = os.getenv("GW_TELEGRAM_WEBAPP_QUIZ_URL", "/join")
